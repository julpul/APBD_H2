...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Where(emp=>emp.Mgr is not null).ToList(); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps,emp =>emp.Mgr,emp1 =>emp1.EmpNo,(emp,emp1)=>new
        {
         Employee = emp.EName,
         Manager = emp1.EName,
        });
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, emp => emp.DeptNo, dept => dept.DeptNo, (emp, dept) => new { emp, dept })
            .SelectMany(ed => grades.Where(s => s.Losal <= ed.emp.Sal && ed.emp.Sal <= s.Hisal), ((arg1, salgrade) =>
                new
                {
                    arg1.emp.EName,
                    arg1.dept.DName,
